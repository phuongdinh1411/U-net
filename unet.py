...
class myUnet(object):
	...
	def __init__(self, img_rows = 128, img_cols = 256):
	...
	def train(self):
		...
		model.fit(imgs_train, imgs_mask_train, batch_size=4, epochs=1, verbose=1,validation_split=0.2, shuffle=True, callbacks=[model_checkpoint])
